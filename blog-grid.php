                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdown05">
                      <li><a class="dropdown-item active" href="blog-grid.php">Blog Grid</a></li>
                      <li><a class="dropdown-item activeSidebar" href="blog-sidebar.php">Blog with Sidebar</a></li>
                      <li><a class="dropdown-item activeSingle" href="blog-single.php">Blog Single</a></li>
