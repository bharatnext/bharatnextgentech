        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-5">
                    <div class="blog-item">
                        <img loading="lazy" src="images/blog/appdevelopment.jpg" alt="blog" class="img-fluid rounded">
                        ...
                        <div class="blog-item-content bg-white p-5">
                            ...
                            <h3 class="mt-3 mb-3"><a href="blog-single.php">Why App Development is Imporatant?</a></h3>
                            <p class="mb-4"> In today's fast-paced, technology-driven world.</p>

                            <a href="blog1.php" class="btn btn-small btn-main btn-round-full">Learn More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 mb-5">
                    <div class="blog-item">
                        ...
                        <div class="blog-item-content bg-white p-5">
                            ...
                            <h3 class="mt-3 mb-3"><a href="blog-single.php">Marketing Strategy to bring more affect</a>
                            </h3>
                            <p class="mb-4">Non illo quas blanditiis repellendus laboriosam minima animi. Consectetur
                                accusantium
                                pariatur repudiandae!</p>
