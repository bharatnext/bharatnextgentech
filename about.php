...
<body>
								...
								<ul class="navbar-nav ml-auto">
									...
									<li class="nav-item dropdown active">
										...
										<ul class="dropdown-menu" aria-labelledby="dropdown03">
											<li><a class="dropdown-item active" href="about.php">Our company</a></li>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="about-item pr-3 mb-5 mb-lg-0">
						...
						<a href="contact.php" class="btn btn-main btn-round-full">Get started</a>
					</div>
				</div>
				<div class="col-lg-6">
	...
	<section class="section counter bg-counter d-none">
		<div class="container">
			<div class="row">
	...
	<section class="section team d-none">
		<div class="container">
			<div class="row justify-content-center">
	...
	<section class="section testimonial bg-gray d-none">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-7 text-center">
					<div class="section-title">
